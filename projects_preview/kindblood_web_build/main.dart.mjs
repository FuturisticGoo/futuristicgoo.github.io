...
class CompiledApp {
  ...
  async instantiate(additionalImports, {loadDeferredWasm, loadDynamicModule} = {}) {
    ...
    const dart2wasm = {
      ...
      _1289: (x0,x1,x2) => ({enableHighAccuracy: x0,timeout: x1,maximumAge: x2}),
      _1290: (x0,x1,x2,x3) => x0.getCurrentPosition(x1,x2,x3),
      _1291: (x0,x1) => x0.clearWatch(x1),
      ...
      _1294: (x0,x1,x2,x3) => x0.watchPosition(x1,x2,x3),
      _1295: Date.now,
      ...
      _1570: () => globalThis.XMLHttpRequest.UNSENT,
      _1574: () => globalThis.XMLHttpRequest.DONE,
      _1579: x0 => x0.readyState,
      _1581: (x0,x1) => x0.timeout = x1,
      _1583: (x0,x1) => x0.withCredentials = x1,
      _1584: x0 => x0.upload,
      _1585: x0 => x0.responseURL,
      _1586: x0 => x0.status,
      _1587: x0 => x0.statusText,
      ...
      _3810: x0 => x0.geolocation,
      _3815: x0 => x0.permissions,
      _3829: x0 => x0.userAgent,
      _10082: x0 => x0.state,
      _11402: x0 => x0.coords,
      _11403: x0 => x0.timestamp,
      _11405: x0 => x0.accuracy,
      _11406: x0 => x0.latitude,
      _11407: x0 => x0.longitude,
      _11408: x0 => x0.altitude,
      _11409: x0 => x0.altitudeAccuracy,
      _11410: x0 => x0.heading,
      _11411: x0 => x0.speed,
      _11415: x0 => x0.code,
      _11416: x0 => x0.message,
...
"https://",
"/search?q=",
"&format=json&polygon_geojson=1&addressdetails=1&accept-language=",
...
"^[^A-Za-z\\u00C0-\\u00D6\\u00D8-\\u00F6\\u00F8-\\u02B8\\u0300-\\u0590\\u0800-\\u1FFF\\u2C00-\\uFB1C\\uFDFE-\\uFE6F\\uFEFD-\\uFFFF]*[\\u0591-\\u07FF\\uFB1D-\\uFDFD\\uFE70-\\uFEFC]",
"btn1",
"btn2",
"btn3",
"getLocation",
"NULL_RESULT",
"The results from getLocation is null",
"time",
"isMock",
"verticalAccuracy",
"headingAccuracy",
...
"requestPermission",
"grantedLimited",
"Could not decode parsePermissionStatus with ",
"UNKNOWN_NATIVE_MESSAGE",
"PermissionStatus.",
"hasPermission",
"requestService",
"serviceEnabled",
...
"offset calculation faild to converge!",
"Server",
"server",
"Simulation",
"simulation",
...
"TileCoordinate(",
"_tileScaleCalculator",
"Wrapped bounds must wrap on at least one axis",
"DiscreteTileRange(",
